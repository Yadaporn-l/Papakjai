...
const [previewModal, setPreviewModal] = useState({ 
  ...
  const regions = [
      { id: 'all', label: '🌐 ทุกภาษา' },
    
    // เอเชีย
    { id: 'thailand', label: '🇹🇭 ภาษาไทย' },
    { id: 'japan', label: '🇯🇵 ภาษาญี่ปุ่น' },
    { id: 'korea', label: '🇰🇷 ภาษาเกาหลี' },
    { id: 'china', label: '🇨🇳 ภาษาจีน' },
    { id: 'vietnam', label: '🇻🇳 ภาษาเวียดนาม' },
    { id: 'indonesia', label: '🇮🇩 ภาษาอินโดนีเซีย' },
    { id: 'malaysia', label: '🇲🇾 ภาษามาเลย์' },
    { id: 'philippines', label: '🇵🇭 ภาษาฟิลิปปินส์' },
    { id: 'india', label: '🇮🇳 ภาษาฮินดี' },
    
    // ยุโรป
    { id: 'france', label: '🇫🇷 ภาษาฝรั่งเศส' },
    { id: 'germany', label: '🇩🇪 ภาษาเยอรมัน' },
    { id: 'italy', label: '🇮🇹 ภาษาอิตาลี' },
    { id: 'spain', label: '🇪🇸 ภาษาสเปน' },
    
    // อื่นๆ
    { id: 'singapore', label: '🇸🇬 ภาษาอังกฤษ (สิงคโปร์)' },
    { id: 'uk', label: '🇬🇧 ภาษาอังกฤษ (UK)' },
    { id: 'usa', label: '🇺🇸 ภาษาอังกฤษ (USA)' },
    { id: 'australia', label: '🇦🇺 ภาษาอังกฤษ (ออสเตรเลีย)' }
